             ...
             new Quizs
                {
                    ...
                    MissingWords = new List<string> { "taket", "golvet", "trädet" } // "taket" = "roof"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "pasta", "pizza", "sushi" } // "pasta" is correct
                },
                new Quizs
                {
                    EnglishText = "The sky is blue today, with no clouds in sight.",
                    SwedishText = "Himlen är ___ idag, utan några moln i sikte.",
                    MissingWords = new List<string> { "blå", "grön", "grå" } // "blå" = "blue"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "bok", "tidning", "tidsskrift" } // "bok" = "book"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "ljus", "mörk", "kall" } // "ljus" = "bright"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "lärare", "förare", "sångare" } // "lärare" = "teacher"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "parken", "stranden", "köpcentret" } // "parken" = "park"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "blå", "grön", "röd" } // "blå" = "blue"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "fotboll", "schack", "gitarr" } // "fotboll" = "soccer"
                },
                new Quizs
                {
                    ...
                    MissingWords = new List<string> { "kall", "het", "regnig" } // "kall" = "cold"
                }
            };
