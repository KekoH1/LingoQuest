...
const Kap3_native = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Navbar />
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <Text style={styles.heading}>Verb</Text>
        <Text style={styles.paragraph}>Här kan du lära dig om verb och hur verb används</Text>
