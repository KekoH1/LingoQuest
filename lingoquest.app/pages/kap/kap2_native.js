...
const Kap2_native = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Navbar />
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <Text style={styles.heading}>Moderna Språket</Text>
        <Text style={styles.paragraph}>Här kan du lära dig om hur språket används idag</Text>
